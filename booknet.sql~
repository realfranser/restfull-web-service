...
*/
INSERT INTO `users` (`user_id`,`user_name`,`email`,`born_date`,`reg_date`) VALUES (1,'user1','mail1@mail.com','1/1/1','2/2/2');
INSERT INTO `users` (`user_id`,`user_name`,`email`,`born_date`,`reg_date`) VALUES (2,'user2','mail2@mail.com','2/2/2','3/3/3');
