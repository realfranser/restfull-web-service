...
*/
INSERT INTO `users` (`user_id`,`user_name`,`email`,`edad`) VALUES (1,'user1','mail1@mail.com','1');
INSERT INTO `users` (`user_id`,`user_name`,`email`,`edad`) VALUES (2,'user2','mail2@mail.com','2');
